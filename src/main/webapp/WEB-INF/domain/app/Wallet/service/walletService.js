...
app.factory("AddNewRecord", function($resource){
	return $resource("/timeron-nexus/v1/wallet/addNewRecord", 
			{}, 
			{query: { method: "POST", isArray: false }}
		);
});
...
app.factory("GetAllRecordTypes", function($resource){
	return $resource("/timeron-nexus/v1/wallet/getAllRecordTypes", 
			{}, 
...
app.factory("GetAllUserAccounts", function($resource){
	return $resource("/timeron-nexus/v1/wallet/getAllUserAccounts", 
			{}, 
			{query: { method: "GET", isArray: true }}
		);
});